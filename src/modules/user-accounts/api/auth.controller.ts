...
import { ExtractUserIdFromRequest } from '../guards/decorators/param/extract-user-from-request.decorator';
...
export class AuthController {
  ...
  me(@ExtractUserIdFromRequest() userId: string): Promise<MeViewDto> {
